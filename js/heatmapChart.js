class HeatmapChart {
    constructor(_config) {
        ...
        this.maxValuesPerMonth = {
            'Jan': 2952, 'Feb': 2535, 'Mar': 2745, 'Apr': 2695, 'May': 2650, 'Jun': 3324,
            'Jul': 4184, 'Aug': 4133, 'Sep': 3881, 'Oct': 3626, 'Nov': 3311, 'Dec': 2746
        };
    ...
    updateVis() {
        let vis = this;
        vis.cells = vis.svg.selectAll(".cell")
            ...
            .on("mouseover", function (event, d) {
                const formattedMonthName = d3.timeFormat("%B")(new Date(2000, d.month - 1));
    ...
    initializeColorScales() {
        ...
        this.monthNames.forEach(month => {
            ...
            const colorScale = d3.scaleLinear()
                .domain([0, 10, 50, 100, 200, 500, 900, remaining / 3 + 1000, remaining * 2 / 3 + 1000, remaining + 1000, max])
