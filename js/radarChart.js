class RadarChart {
    constructor(_config) {
        ...
        this.maxFrequencies = {
            "24": 4802, "01": 3210, "02": 2353, "03": 2008, "04": 1529, "05": 1590,
            "06": 1224, "07": 905, "08": 803, "09": 958, "10": 1166, "11": 1144,
            "12": 1368, "13": 1303, "14": 1322, "15": 1433, "16": 1620, "17": 2592,
            "18": 4002, "19": 6147, "20": 8617, "21": 11445, "22": 10837, "23": 7953
        };
    ...
    initVis() {
        ...
        vis.labels = vis.svg.selectAll(".radarLabel")
            ...
            .attr("x", (d, i) => (vis.radius + vis.config.margin.top / 2 + 10) * Math.cos(vis.getAngle(i)))
            .attr("y", (d, i) => (vis.radius + vis.config.margin.top / 2 + 10) * Math.sin(vis.getAngle(i)))
    ...
    updateVis() {
        ...
        vis.hoverSvg.selectAll(".axis-hover")
            .data(vis.agreggatedData)
            .enter().append("line")
